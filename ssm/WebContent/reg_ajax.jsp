...
<script>
   ...
   $(function(){
	   $("input:first").blur(function(){
		   ...
		   $.ajax({
			   type:"get",
			   url:"<%=path%>/user/check?name="+userName+"&time=<%=new Date().getTime()%>",
			   dataType:"text",
			   cache:false,
			   success:function(data){$("#tip").text(data);},
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    <td align="left" valign="top" id="addinfo">
     <a href="#" target="mainFrame" onFocus="this.blur()" class="add">用户注册</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="<%=path%>/user/reg">
